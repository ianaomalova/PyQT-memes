...
navbar_text = """
    QLabel {
        ...
        background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
            stop:0 rgba(255, 255, 255, 0.8), stop:1 rgba(170, 255, 189, 0.9));
...
load_buttons = """
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(0, 180, 255, 0.8), stop:1 rgba(27, 59, 222, 0.8));
                color: white;
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(0, 180, 255, 1.0), stop:1 rgba(27, 59, 222, 1.0));
                border: 2px solid #e0a800;
            }

            QPushButton:pressed {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(0, 180, 255, 0.9), stop:1 rgba(45, 140, 181, 0.9));
...
cleanButton = """
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(214, 39, 39, 0.8), stop:1 rgba(214, 39, 39, 0.8));
                color: white;
                border: 2px solid #ffc107;
                border-radius: 10px;
                padding: 14px 20px;
