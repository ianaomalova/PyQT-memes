...
navbar_icon = """
    QLabel {
        ...
        background: qlineargradient(x1:0, y1:0, x2:1, y2:1,
            stop:0 rgba(52, 73, 94, 0.3), stop:1 rgba(41, 128, 185, 0.2));
    ...
    QLabel:hover {
        background: qlineargradient(x1:0, y1:0, x2:1, y2:1,
            stop:0 rgba(52, 73, 94, 0.5), stop:1 rgba(41, 128, 185, 0.4));
...
navbar_text = """
    QLabel {
        ...
        background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
            stop:0 rgba(44, 62, 80, 0.8), stop:1 rgba(52, 73, 94, 0.6));
    ...
    QLabel:hover {
        background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
            stop:0 rgba(52, 73, 94, 0.9), stop:1 rgba(64, 86, 109, 0.8));
...
load_buttons = """
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(41, 128, 185, 0.9), stop:1 rgba(52, 152, 219, 0.9));
                color: white;
